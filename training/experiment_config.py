...
class Configuration(object):
    def __init__(self) -> None:
        ...
        self.CSV_DIR_TRAIN = self.CSV_DIR / "train.csv" #"train.csv" # Path to the training CSV
        ...
        self.EXPERIMENT_NAME = "Resnet18_15e_64bs_lr2"
        self.MODE = "2D" #  or 3D
        ...
        self.SIZE_MM = 50
        self.SIZE_PX = 224 #64
        self.BATCH_SIZE = 16 #448
        self.ROTATION =  ((-20, 20), (-20, 20), (-20, 20)) # ((-1,1), (-1,1), (-1,1))
